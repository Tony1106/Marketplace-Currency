        ...
        <div>
          ...
          <div className={style["button-group"]}>
            <div className={`${style["button-sell"]}  ${style.button}`}>
              <button
                className={isBuy ? style.active : null}
            ...
            <div className={`${style["button-buy"]}  ${style.button}`}>
              <button
                className={!isBuy ? style.active : null}
                onClick={() => this.setState({ isBuy: false })}
              >
                Sell
              </button>
            </div>
          ...
          <div className={style.detail}>
            {this.state.isBuy ? (
              <BuyForm onChange={values => this.handleChangeBuyForm(values)} />
            ) : (
              <SellForm
                onChange={values => this.handleChangeSellForm(values)}
              />
            )}
          </div>
        </div>
