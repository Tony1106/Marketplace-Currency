          ...
          <NavItem>
            <NavLink
              className={`${styles.navItem} ${
                createAdsClassActive ? styles.active : ""
              }`}
              tag={Link}
              to="/dashboard"
            >
        ...
        <Collapse isOpen={this.state.isOpen} navbar>
          <Nav className="ml-auto " navbar pills>
            ...
            <NavItem>
              <NavLink
                className={`${styles.navItem} ${
                  marketPlaceClassActive ? styles.active : ""
                }`}
                tag={Link}
                to="/marketplace"
              >
            ...
            <NavItem>
              <NavLink
                className={`${styles.navItem} ${
                  aboutClassActive ? styles.active : ""
                }`}
                tag={Link}
                to="/About"
              >
            ...
            <NavItem>
              <NavLink
                className={`${styles.navItem} ${
                  contactClassActive ? styles.active : ""
                }`}
                tag={Link}
                to="/Contact"
              >
